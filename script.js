...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const quotes = [
    ...
    { id: 27, text: "Поздравляю с 8 Марта! Желаю, чтобы вся жизнь была похожа на прекрасный весенний день, наполненный любовью и радостью, веселым пением птиц и яркостью прекрасных цветов. Пусть сбываются мечты, пусть случаются только приятные сюрпризы!", author: "Угурчиев Тагир" },
    { id: 28, text: "Веселья и фарта, поздравляю с Восьмым марта!", author: "Денис Билецкий" },
  ...
  const authors = [
    ...
    { id: 27, name: "Угурчиев Тагир" },
    { id: 28, name: "Денис Билецкий" },
